...
<html>
    ...
    function selectItem(index) {
		window.open('item_select.html?index=' + index, '请选择物料', 'width=700, height=400, scrollbars=no');
    } 
					...
					<tr>
						...
						<td width="16%">
							...
							<input name="btnSelectClient" type="button" id="btnSelectClient"
								value="..." class="button1"
								onClick="window.open('<%=basePath%>flowcard/FlowCardController?command=selectClient', '选择分销商', 'width=700, height=400, scrollbars=no')">
						</td>
						<td width="16%">
							<div align="right">
								供方分销商名称:&nbsp;
