...
<form name="userform" id="userform">
    <div align="center">
        <table width="95%" border="0" cellspacing="0" cellpadding="0" height="35">
            ...
            <tr>
                <td width="522" class="p1" height="17" nowrap><img src="images/mark_arrow_02.gif" width="14"
                                                                   height="14"> &nbsp; <b>订单管理&gt;&gt;未处理订单</b></td>
            </tr>
        </table>
    ...
    <table id="userListTable" width="95%" border="1" cellspacing="0" cellpadding="0" align="center" class="table1">
        ...
        <c:forEach var="order" items="${list}">
            <tr>
                <td width="55" class="rd6"><input type="checkbox" value="${order.id}"/></td>
                <td width="119" class="rd6">${order.orderNo}</td>
                <td width="152" class="rd6">${order.orderPersonName}</td>
                <td width="166" class="rd6">${order.orderPersonTel}</td>
                <td width="166" class="rd6">${order.hotelName}</td>
                <td width="166" class="rd6">${order.cityName}</td>
                <td width="150" class="rd6">${order.email}</td>
                <td width="153" class="rd6">${order.createDate}</td>
                <td width="153" class="rd6"><a href="#">处理</a></td>
            </tr>
        </c:forEach>
    </table>
            ...
            <td nowrap class="rd19">
                <div align="right">
                    <input name="btnTopPage" class="button1" type="button" id="btnTopPage" value="|&lt;&lt; " title="首页"
                           onClick="topPage()">
                    <input name="btnPreviousPage" class="button1" type="button" id="btnPreviousPage" value=" &lt;  "
                           title="上页" onClick="previousPage()">
                    <input name="btnNextPage" class="button1" type="button" id="btnNextPage" value="  &gt; " title="下页"
                           onClick="nextPage()">
                    <input name="btnBottomPage" class="button1" type="button" id="btnBottomPage" value=" &gt;&gt;|"
                           title="尾页" onClick="bottomPage()">
                    <input name="btnAdd" type="button" class="button1" id="btnAdd" value="添加" onClick="addUser()">
                    <input name="btnDelete" class="button1" type="button" id="btnDelete" value="删除"
                           onClick="deleteUser()">
