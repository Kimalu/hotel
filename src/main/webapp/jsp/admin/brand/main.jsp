...
<table width="95%" border="0" cellspacing="0" cellpadding="0" height="35">
	...
	<tr>
		<td width="522" class="p1" height="17" nowrap><img src="images/mark_arrow_02.gif" width="14" height="14"> &nbsp; <b>Kimalu酒店系统&gt;&gt;酒店管理&gt;&gt;品牌管理</b></td>
	</tr>
</table>
...
<table id="userListTable" width="95%" border="1" cellspacing="0" cellpadding="0" align="center" class="table1">
	<tr>
		...
		<td width="119" class="rd6">品牌名称</td>
		<td width="152" class="rd6">星级</td>
		<td width="166" class="rd6">评分</td>
		<td width="150" class="rd6">描述信息</td>
        <td width="150" class="rd6">操作</td>
	</tr>
    <c:forEach var="brand" items="${brandList}">
        <tr>
            <td width="55" class="rd6"><input type="checkbox" id="${brand.id}" ></td>
            <td width="119" class="rd6">${brand.name.chs}</td>
            <td width="152" class="rd6">${brand.level}</td>
            <td width="166" class="rd6">${brand.score}</td>
            <td width="150" class="rd6">${brand.description.chs}</td>
            <td width="150" class="rd6"><a href="#">详细</a></td>
        </tr>
